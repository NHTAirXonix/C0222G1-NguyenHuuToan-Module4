...
//    private Set<Contract> contract;
    ...
    public Service(int id, String name, int area, double cost, int amountCustomer, String standardRoom, String description, int poolArea, int floor, int status, RentType rentType, ServiceType serviceType) {
        this.id = id;
        this.name = name;
        this.area = area;
        this.cost = cost;
