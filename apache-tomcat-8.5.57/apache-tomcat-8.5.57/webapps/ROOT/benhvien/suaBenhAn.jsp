...
<div class="custom_background" style="margin: 0;padding: 0;width: 100%">
    <div class="row" style="width: 100%">
        <div class="col-2"></div>
        <div class="col-8">
            <form var="benhan" items="${benhAn}" action="/hosobenhan?action=suaBenhAn" method="Post" style="border: black solid 1px; background-color: #ffffff;opacity: 90%;padding: 20px;margin-top: 50px;border-radius: 10px;margin-bottom: 50px">
                <p style="text-align: center;font-size: 25px"><b>SUA BENH AN</b></p>
                <div class="mb-2">
                    <label  class="form-label">ID BENH AN</label>
                    <input type="text" class="form-control" name="customer_id" value="${benhan.idHoSoBenhAn}" required readonly = "readonly" placeholder="${customerSelect.customer_id}">
                </div>
                <div class="mb-2">
                    <label  class="form-label">MA BENH AN</label>
                    <input type="text" class="form-control" name="customer_type_id" value="${benhan.id_benh_an}">
                </div>
                <div class="mb-2">
                    <label  class="form-label">MA BENH NHAN</label>
                    <input type="text" class="form-control" name="customer_name" value="${benhan.id_benh_nhan}">
                </div>
                <div class="mb-2">
                    <label  class="form-label">TEN BENH NHAN</label>
                    <input type="text" class="form-control" name="customer_birthday" value="${benhan.tenBenhNhan}">
                </div>
                <div class="mb-2">
                    <label class="form-label">NGAY NHAP VIEN</label>
                    <input type="text" class="form-control" name="customer_gender" value="${benhan.ngayNhapVien}">
                </div>
                <div class="mb-2">
                    <label  class="form-label">NGAY RA VIEN</label>
                    <input type="text" class="form-control" name="customer_id_card" value="${benhan.ngayRaVien}">
                </div>
                <div class="mb-2">
                    <label  class="form-label">LY DO NHAP VIEN</label>
                    <input type="text" class="form-control" name="customer_phone" value="${benhan.lyDoNhapVien}">
                </div>
